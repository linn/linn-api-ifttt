namespace Linn.Api.Ifttt.Testing.Integration.Modules
{
    ...
    public class WhenConfiguringDeviceIdForUnmutingASpecificDevice : ContextBase
    {
        ...
        public WhenConfiguringDeviceIdForUnmutingASpecificDevice()
        {
            var request = new { };
            ...
            this.response = this.Client.PostAsync("/ifttt/v1/actions/unmute_device/fields/device_id/options", content).Result;
