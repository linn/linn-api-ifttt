namespace Linn.Api.Ifttt.Testing.Integration.Modules
{
    ...
    public class WhenStartPlaylistOnASpecificDeviceWithMissingPlaylistId : ContextBase
    {
        private readonly HttpResponseMessage response;

        private readonly ErrorResource result;

        public WhenStartPlaylistOnASpecificDeviceWithMissingPlaylistId()
        {
        ...
        public void ShouldDescribeError()
        {
            ...
            this.result.Errors[0].Message.Should().Be("Action field `playlist_id` missing");
        }
    }
}
