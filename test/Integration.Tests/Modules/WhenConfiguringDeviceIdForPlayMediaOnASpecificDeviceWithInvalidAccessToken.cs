namespace Linn.Api.Ifttt.Testing.Integration.Modules
{
    ...
    public class WhenConfiguringDeviceIdForPlayMediaOnASpecificDeviceWithInvalidAccessToken : ContextBase
    {
        ...
        public WhenConfiguringDeviceIdForPlayMediaOnASpecificDeviceWithInvalidAccessToken()
        {
