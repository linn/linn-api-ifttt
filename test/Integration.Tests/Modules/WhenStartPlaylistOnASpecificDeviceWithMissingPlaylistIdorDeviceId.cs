namespace Linn.Api.Ifttt.Testing.Integration.Modules
{
    ...
    public class WhenStartPlaylistOnASpecificDeviceWithMissingPlaylistIdorDeviceId : ContextBase
    {
        private readonly HttpResponseMessage response;

        private readonly ErrorResource result;

        public WhenStartPlaylistOnASpecificDeviceWithMissingPlaylistIdorDeviceId()
        {
            var request = new
                              {
                                  actionFields = new { },
        ...
        public void ShouldDescribeError()
        {
            ...
            this.result.Errors.Should().Contain(e => e.Message == "Action field `playlist_id` missing");
