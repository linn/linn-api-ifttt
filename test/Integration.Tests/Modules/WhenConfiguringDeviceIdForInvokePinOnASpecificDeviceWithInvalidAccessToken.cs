namespace Linn.Api.Ifttt.Testing.Integration.Modules
{
    ...
    public class WhenConfiguringDeviceIdForInvokePinOnASpecificDeviceWithInvalidAccessToken : ContextBase
    {
        private readonly HttpResponseMessage response;

        private readonly ErrorResource result;

        public WhenConfiguringDeviceIdForInvokePinOnASpecificDeviceWithInvalidAccessToken()
        {
            var request = new { };
            ...
            this.response = this.Client.PostAsync("/ifttt/v1/actions/invoke_pin/fields/device_id/options", content).Result;
